...
facebook facebook.com/mohamedseabeai
...
$redirect_url = 'http://localhost/test_login/login.php'; // redirect url that you inserted in google cloud api
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary bg-gradient">
        <div class="container">
            <a class="navbar-brand" href="./">Google OAuth Integration in PHP With Mohamed sebai</a>
            <div>
